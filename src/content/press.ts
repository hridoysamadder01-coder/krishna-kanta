...
export const mediaGuidelines = {
  en: [
    ...
    "For ECOM-EASY, the leadership line is: Krishna Kanta — Founder & Chairman; Mr. Hashmi — CEO, Marketing Sector.",
    ...
    "Company names — Computer Zone, OushodhOS, OYSHE AI, ECOM-EASY — should not be translated or restyled.",
  ],
  bn: [
    ...
    "ECOM-EASY প্রসঙ্গে নেতৃত্বের বিন্যাস: Krishna Kanta — প্রতিষ্ঠাতা ও চেয়ারম্যান; Mr. Hashmi — সিইও, মার্কেটিং সেক্টর।",
    ...
    "প্রতিষ্ঠানের নাম — Computer Zone, OushodhOS, OYSHE AI, ECOM-EASY — অনুবাদ বা রূপান্তর করবেন না।",
  ],
} as const;
