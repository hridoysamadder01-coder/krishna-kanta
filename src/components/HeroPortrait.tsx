...
/**
 * Cinematic full-height hero: monumental serif name, editorial portrait
 * emerging from darkness, fine gold rule, staggered copy. All motion is
...
export function HeroPortrait({ locale }: { locale: Locale }) {
  ...
  return (
    <section className="film-grain relative isolate flex min-h-svh flex-col justify-end overflow-hidden bg-ink">
